  ...
  return (
    <section className="flex flex-col gap-5 panel p-5">
      ...
      <div className="flex items-baseline gap-2">
        <span className="font-[family-name:var(--font-bricolage)] text-[2.6rem] font-semibold leading-none text-accent-strong">
          {balance}
        </span>
      ...
      <div className="flex flex-col gap-2 rounded-[var(--radius-control)] bg-surface-sunken px-4 py-3">
        <div className="flex items-baseline justify-between gap-2">
          ...
          <span className="font-[family-name:var(--font-bricolage)] text-xl font-semibold tabular-nums">
      ...
      {status.code && (
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center justify-between gap-3 rounded-[var(--radius-control)] bg-surface-sunken px-4 py-3">
            ...
            <span className="font-[family-name:var(--font-bricolage)] text-xl font-semibold tracking-[0.18em] tabular-nums">
              {status.code}
            </span>
            <button
              type="button"
