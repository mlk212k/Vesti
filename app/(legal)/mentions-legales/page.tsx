  ...
  return (
    <>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="label text-muted">Éditeur du site</h2>
        <p>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="label text-muted">Directeur de la publication</h2>
        <p>{LEGAL.directeurPublication}</p>
      </section>

      <section className="flex flex-col gap-2">
        <h2 className="label text-muted">Hébergement</h2>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="label text-muted">Propriété intellectuelle</h2>
        <p>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="label text-muted">Signaler un contenu</h2>
        <p>
