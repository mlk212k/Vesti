  ...
  return (
    <>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-base ">Responsable du traitement</h2>
        <p>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-base ">Ce que nous collectons</h2>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-base ">Pourquoi, et sur quelle base</h2>
        <p>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-base ">Qui y a accès</h2>
        <p>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-base ">Combien de temps</h2>
        <ul className="flex flex-col gap-1">
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-base ">Tes droits</h2>
        <p>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-base ">Cookies</h2>
        <p>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-base ">Mineurs</h2>
        <p>
