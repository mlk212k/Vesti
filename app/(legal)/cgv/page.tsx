  ...
  return (
    <>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-base ">1. Objet</h2>
        <p>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-base ">2. Le service</h2>
        <p>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-base ">3. Formules et prix</h2>
        <p>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-base ">4. Souscription et paiement</h2>
        <p>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-base ">5. Droit de rétractation</h2>
        <p>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-base ">6. Résiliation</h2>
        <p>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-base ">7. Obligations de l&apos;utilisateur</h2>
        <p>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-base ">8. Disponibilité et responsabilité</h2>
        <p>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-base ">9. Données personnelles</h2>
        <p>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-base ">10. Médiation de la consommation</h2>
        <p>
          {LEGAL.mediateur ? (
            <>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-base ">11. Droit applicable</h2>
        <p>
